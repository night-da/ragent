...
import com.ragent.ai.knowledge.controller.request.KnowledgeChunkBatchRequest;
import com.ragent.ai.knowledge.controller.request.KnowledgeChunkCreateRequest;
import com.ragent.ai.knowledge.controller.request.KnowledgeChunkPageRequest;
import com.ragent.ai.knowledge.controller.request.KnowledgeChunkUpdateRequest;
import com.ragent.ai.knowledge.controller.vo.KnowledgeChunkVO;
import com.ragent.ai.core.chunk.VectorChunk;
import com.ragent.ai.knowledge.dao.entity.KnowledgeChunkDO;
...
import com.ragent.ai.knowledge.dao.mapper.KnowledgeChunkMapper;
...
import com.ragent.ai.framework.exception.ServiceException;
import com.ragent.ai.infra.embedding.EmbeddingService;
import com.ragent.ai.infra.token.TokenCounterService;
...
public class KnowledgeChunkServiceImpl implements KnowledgeChunkService {
    ...
    public void updateEnabledByDocId(String docId, String kbId, boolean enabled) {
        ...
        log.info("根据文档 ID 更新所有 Chunk 启用状态, kbId={}, docId={}, enabled={}", kbId, docId, enabled);
    }
    ...
    private void validateDocumentEnabledForChunkEnable(KnowledgeDocumentDO documentDO, boolean enableChunk) {
        ...
        if (!Integer.valueOf(1).equals(documentDO.getEnabled())) {
            throw new ClientException("文档未启用，无法启用 Chunk，请先启用文档");
        }
    }
