...
import com.ragent.ai.rag.controller.request.IntentNodeCreateRequest;
import com.ragent.ai.rag.controller.request.IntentNodeUpdateRequest;
import com.ragent.ai.rag.controller.vo.IntentNodeTreeVO;
import com.ragent.ai.rag.dao.entity.IntentNodeDO;
import com.ragent.ai.rag.dao.mapper.IntentNodeMapper;
import com.ragent.ai.knowledge.dao.mapper.KnowledgeBaseMapper;
import com.ragent.ai.rag.enums.IntentKind;
import com.ragent.ai.rag.enums.IntentLevel;
...
import com.ragent.ai.rag.core.intent.IntentNode;
import com.ragent.ai.rag.core.intent.IntentTreeCacheManager;
import com.ragent.ai.rag.core.intent.IntentTreeFactory;
import com.ragent.ai.ingestion.service.IntentTreeService;
...
public class IntentTreeServiceImpl extends ServiceImpl<IntentNodeMapper, IntentNodeDO> implements IntentTreeService {
    ...
    public String createNode(IntentNodeCreateRequest requestParam) {
        ...
        if (Objects.equals(requestParam.getLevel(), IntentLevel.TOPIC.getCode())
            ...
            throw new ClientException("TOPIC 级别的 RAG 检索节点必须指定目标知识库");
        }
    ...
    private List<IntentNodeDO> listAndValidateTargetNodes(List<String> ids) {
        ...
        Assert.notEmpty(normalizedIds, () -> new ClientException("节点 ID 不能为空"));
