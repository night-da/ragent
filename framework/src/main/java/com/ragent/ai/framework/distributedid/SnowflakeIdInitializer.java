...
package com.ragent.ai.framework.distributedid;
...
public class SnowflakeIdInitializer {
    ...
    public void init() {
        ...
        try {
            ...
            log.info("分布式 Snowflake 初始化完成, workerId: {}, datacenterId: {}", workerId, datacenterId);
        } catch (Exception e) {
            throw new RuntimeException("分布式 Snowflake 初始化失败", e);
        }
    }
}
