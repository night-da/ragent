...
import com.ragent.ai.rag.controller.request.MessageFeedbackRequest;
import com.ragent.ai.rag.dao.entity.ConversationMessageDO;
import com.ragent.ai.rag.dao.entity.MessageFeedbackDO;
import com.ragent.ai.rag.dao.mapper.ConversationMessageMapper;
import com.ragent.ai.rag.dao.mapper.MessageFeedbackMapper;
import com.ragent.ai.rag.mq.event.MessageFeedbackEvent;
...
public class MessageFeedbackServiceImpl implements MessageFeedbackService {
    ...
    public void submitFeedbackAsync(String messageId, MessageFeedbackRequest request) {
        ...
        Assert.notBlank(messageId, () -> new ClientException("消息 ID 不能为空"));
    ...
    public void submitFeedbackByEvent(MessageFeedbackEvent event) {
        ...
        Assert.notBlank(messageId, () -> new ClientException("消息 ID 不能为空"));
        Assert.notBlank(userId, () -> new ClientException("用户 ID 不能为空"));
