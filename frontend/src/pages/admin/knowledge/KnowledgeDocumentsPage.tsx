...
const formatChunkStrategy = (strategy?: string | null) => {
  ...
  if (normalized === "structure_aware") return "语义感知（Markdown 友好）";
  return strategy || "-";
};
                ...
                <>
                  ...
                  <div className="space-y-3 rounded-lg border p-3">
                    ...
                    {detailScheduleEnabled ? (
                      <div>
                        <div className="text-sm font-medium mb-2">拉取频率（Cron 表达式）</div>
                        <Input
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        <DialogHeader>
          ...
          <DialogDescription>支持本地文件或远程 URL，并配置分块策略</DialogDescription>
        </DialogHeader>
        <Form {...form}>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>通过 ETL 处理提升文件数据质量，增强向量搜索效果</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
