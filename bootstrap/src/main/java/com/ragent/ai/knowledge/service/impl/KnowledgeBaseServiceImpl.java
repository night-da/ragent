...
import com.ragent.ai.knowledge.controller.request.KnowledgeBaseCreateRequest;
import com.ragent.ai.knowledge.controller.request.KnowledgeBasePageRequest;
import com.ragent.ai.knowledge.controller.request.KnowledgeBaseUpdateRequest;
import com.ragent.ai.knowledge.controller.vo.KnowledgeBaseVO;
...
import com.ragent.ai.rag.core.vector.VectorSpaceSpec;
import com.ragent.ai.rag.core.vector.VectorStoreAdmin;
import com.ragent.ai.knowledge.service.KnowledgeBaseService;
...
public class KnowledgeBaseServiceImpl implements KnowledgeBaseService {
    ...
    public String create(KnowledgeBaseCreateRequest requestParam) {
        ...
        try {
            ...
            log.info("成功创建 RestFS 存储桶，Bucket 名称: {}", bucketName);
        } catch (BucketAlreadyOwnedByYouException | BucketAlreadyExistsException e) {
            if (e instanceof BucketAlreadyOwnedByYouException) {
                log.error("RestFS 存储桶已存在，Bucket 名称: {}", bucketName, e);
            } else {
                log.error("RestFS 存储桶已存在但由其他账户拥有，Bucket 名称: {}", bucketName, e);
            }
