...
package com.ragent.ai.infra.http;
...
/**
 * 模型 URL 解析器
 * 用于解析 AI 模型的完整 URL 地址，支持从候选模型配置或提供商配置中获取 URL
 */
...
public class ModelUrlResolver {
     ...
     *
     * @param provider   提供商配置，包含基础 URL 和端点配置
     * @param candidate  候选模型配置，可能包含自定义 URL
     * @param capability 模型能力类型，用于确定使用哪个端点
     * @return 完整的模型 URL 地址
     * @throws IllegalStateException 当提供商基础 URL 缺失或端点配置缺失时抛出
     */
