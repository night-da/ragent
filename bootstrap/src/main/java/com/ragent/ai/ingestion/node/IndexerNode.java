...
package com.ragent.ai.ingestion.node;
...
import com.ragent.ai.ingestion.domain.result.NodeResult;
import com.ragent.ai.ingestion.domain.settings.IndexerSettings;
...
public class IndexerNode implements IngestionNode {
    ...
    private List<JsonObject> buildRows(IngestionContext context,
        ...
        for (int i = 0; i < chunks.size(); i++) {
            ...
            // 使用原始内容作为存储内容，而不是用于 embedding 的文本
